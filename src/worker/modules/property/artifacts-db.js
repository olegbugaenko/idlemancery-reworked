...
export const registerArtifactsStage1 = () => {
    ...
    registerArtifact('artifact_spear_of_the_stalwart', {
        tags: ["artifact", "upgrade", "purchaseable", "physical", "actions"],
        name: 'Spear of the Stalwart',
        allowedImpacts: ['effects'],
        description: 'A rugged spear symbolizing endurance. Its aura enhances your physical prowess, increasing the efficiency of manual labor tasks.',
        level: 0,
        resourceModifier: {
            get_multiplier: () => ({
                effects: {
