        ...
        resourceModifier: {
            get_income: () => ({
                resources: {
                    inventory_fire: {
                        A: 1.2,
                        B: 0.000125*gameEffects.getEffectValue('conjuration_spells_efficiency')*gameEffects.getEffectValue('elemental_spells_efficiency'),
                        type: 1,
                    }
                }
            }),
            get_consumption: () => ({
                resources: {
                    mana: {
                        A: 1.5,
                        B: 810.0*getCostReduction('spell_conjure_fire')/1.5,
                        type: 1,
                    }
                }
            }),
