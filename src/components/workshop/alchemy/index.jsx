    ...
    return (
        <PerfectScrollbar>
            <div className={'blade-inner'}>
                <div className={'block'}>
                    <h4>Alchemy</h4>
                    <p className={'hint separated'}>You can brew multiple items at once, if you have enough available alchemy slots. Assigning more effort to crafting of specific resource will make crafting faster but more wasteful</p>
                    {!data.isProducingEffort ? (<p className={'hint warning yellow'}>Alchemy requires Alchemy Effort, which is generated by specific actions. To be able to brew something, make sure you are generating Alchemy Effort.</p> ) : null}
                    {!data.hasSlots ? (<p className={'hint warning yellow'}>Each potion brewing require alchemy slot. Make sure you've purchased corresponding furniture</p> ) : null}
                </div>
                <div className={'block'}>
                    <p>General Stats</p>
