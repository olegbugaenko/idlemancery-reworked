    ...
    return (
        <PerfectScrollbar>
            <div className={'blade-inner'}>
                <div className={'block'}>
                    <h4>Crafting</h4>
                    <p className={'hint separated'}>You can craft multiple items at once by assigning crafting effort to different recipes. Assigning more effort to crafting of specific resource will make crafting faster, increasing both input and output</p>
                </div>
                <div className={'block'}>
                    <p>General Stats</p>
                ...
                <div className={'block efficiency-block'}>
                    {item.rebalanceInfo ? (
                        <p className={`hint ${item.rebalanceInfo.isBeneficial ? 'green' : 'yellow'}`}>
                            Crafting Intensity {item.rebalanceInfo.isBeneficial ? 'increased' : 'reduced'} to {formatValue(item.rebalanceInfo.currentEffort * 100)}% due to missing {item.rebalanceInfo.missingResource}
                        </p>
