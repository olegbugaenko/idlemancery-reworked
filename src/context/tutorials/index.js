...
const stepsActionsLists = [
    ...
    },
    {
        ...
        content: 'Auto Effort automatically adjusts this action’s effort so it generates enough of its resource(s) to cover what other actions or systems in the game consume.\n' +
            'For example, if your list and other effects consume 5 Coins per second, it will raise Beggar’s effort to generate 5 Coins per second.\n' +
            'Use Auto to prevent resource shortages and efficiency drops.',
        disableBeacon: true,
        disableOverlayClose: true,
    },
    {
