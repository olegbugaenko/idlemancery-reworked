...
export const subscribeSidebarStore = (listener) => {
...
export const getSidebarSnapshot = () => state;

export const updateSidebarState = (partialState = {}) => {
...
export const useSidebarData = (selector = identity, isEqual = Object.is) => {
    ...
    useEffect(() => {
        ...
        const unsubscribe = subscribeSidebarStore(handleChange);
        return () => {
            unsubscribe?.();
        };
    }, []);
...
export const getDefaultSidebarState = () => defaultState;
